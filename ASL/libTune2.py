...
def run_event_detection(stream, n_trials=50):
    ...
    if len(app.picked_times) == 2:
        ...
        best_params = run_monte_carlo(app.selected_traces, event_start, event_end, n_trials=n_trials)

        if best_params:
            print("\n✅ Best Parameters Found:")
            print(best_params)
            return event_start, event_end, best_params
        else:
...
if __name__ == "__main__":
    ...
    if len(app.picked_times) == 2:
        ...
        best_params = run_monte_carlo(app.selected_traces, event_start, event_end, n_trials=50)
